    ...
    public class Program
    {
        ...
        WebHost.CreateDefaultBuilder(args)
            ...
            .ConfigureAppConfiguration((hostingContext, config) =>
            {
                ...
                config.AddAzureAppConfiguration(options =>
                {
                    options.Connect(settings["AppConfigurationConnectionString"])
                           ...
                           {
                               refresh.Register("ProductsApi:Sentinel", refreshAll: true)
            ...
            .ConfigureLogging((hostingContext, logging) =>
            {
                ...
                .AddConsole()
                .AddDebug()
                .AddApplicationInsights(hostingContext.Configuration.GetSection("ProductsApi:ApplicationInsights:InstrumentationKey").Value);
            });
    }
}